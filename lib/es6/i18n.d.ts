 ...
 */
export declare function i18n(id?: string | number, note?: string): I18N;
/**
 * Create an entry for translation
...
export declare function group(id?: string | number, note?: string, opts?: Record<string, I18N | Group>): Group;
